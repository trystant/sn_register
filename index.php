...
<html>
    <head>
        ...
        <title>New Serial Number Tracker</title>
		...
		<main>
			<div align = "center">
				...
				<h2>Serial Number Registration</h2>
				...
				<input type="submit" form='reset' value="Reset">
					...
					<input type='text' name='DVR_type' list='dvrs'/>
					<datalist id='dvrs'>
						<!--NOTHING-->
						<option value=''>---</option>
						<!--SDI-->
					...
					<?php
						if($_SESSION['inv']!=NULL){
							echo "<input type='text' name='HDD_type' placeholder='HDD Type' autofocus/>";
						} else{
							echo "<input type='text' name='HDD_type' placeholder='HDD Type'/>";
						}
					?>
